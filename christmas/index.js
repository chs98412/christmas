...
//santa
var santas=[];
santas.push([1,'red',700,900,70, 0, Math.PI * 2])
santas.push([1,'hsl(33.87,40%,80%)',700,800,50, 0, Math.PI * 2])
santas.push([1,'black',700,775,50, Math.PI * 0.35, Math.PI * 0.65])
santas.push([1,'black',685,785,5, 0, Math.PI * 2])
santas.push([1,'black',715,785,5, 0, Math.PI * 2])
santas.push([1,'black',700,890,5, 0, Math.PI * 2])
santas.push([1,'black',700,920,5, 0, Math.PI * 2])
santas.push([1,'black',700,860,5, 0, Math.PI * 2])
santas.push([1,'orange',700,798,5, 0, Math.PI * 2])
santas.push([1,'pink',670,803,5, 0, Math.PI * 2])
santas.push([1,'pink',730,803,5, 0, Math.PI * 2])
santas.push([1,'white',700,850,10, 0, Math.PI * 2])
santas.push([1,'white',690,850,10, 0, Math.PI * 2])
santas.push([1,'white',680,850,10, 0, Math.PI * 2])
santas.push([1,'white',670,840,10, 0, Math.PI * 2])

santas.push([1,'white',710,850,10, 0, Math.PI * 2])
santas.push([1,'white',720,850,10, 0, Math.PI * 2])
santas.push([1,'white',730,840,10, 0, Math.PI * 2])

santas.push([1,'white',700,860,10, 0, Math.PI * 2])
santas.push([1,'white',690,860,10, 0, Math.PI * 2])
santas.push([1,'white',710,860,10, 0, Math.PI * 2])
santas.push([1,'white',700,870,10, 0, Math.PI * 2])

santas.push([1,'red',700,760,10, 0, Math.PI * 2])
santas.push([1,'red',690,760,10, 0, Math.PI * 2])
santas.push([1,'red',710,760,10, 0, Math.PI * 2])
santas.push([1,'red',680,760,10, 0, Math.PI * 2])
santas.push([1,'red',720,760,10, 0, Math.PI * 2])
santas.push([1,'red',670,763,10, 0, Math.PI * 2])
santas.push([1,'red',730,763,10, 0, Math.PI * 2])
santas.push([1,'red',700,750,10, 0, Math.PI * 2])
santas.push([1,'red',690,750,10, 0, Math.PI * 2])
santas.push([1,'red',680,750,10, 0, Math.PI * 2])
santas.push([1,'red',710,750,10, 0, Math.PI * 2])
santas.push([1,'red',720,750,10, 0, Math.PI * 2])
santas.push([1,'red',730,750,10, 0, Math.PI * 2])

santas.push([1,'red',700,740,10, 0, Math.PI * 2])
santas.push([1,'red',690,740,10, 0, Math.PI * 2])
santas.push([1,'red',710,740,10, 0, Math.PI * 2])
santas.push([1,'red',720,740,10, 0, Math.PI * 2])
santas.push([1,'red',730,740,10, 0, Math.PI * 2])

santas.push([1,'red',700,730,10, 0, Math.PI * 2])
santas.push([1,'red',710,730,10, 0, Math.PI * 2])
santas.push([1,'red',720,730,10, 0, Math.PI * 2])
santas.push([1,'red',730,730,10, 0, Math.PI * 2])

santas.push([1,'red',710,720,10, 0, Math.PI * 2])
santas.push([1,'red',720,720,10, 0, Math.PI * 2])
santas.push([1,'red',730,720,10, 0, Math.PI * 2])
santas.push([1,'white',720,700,10, 0, Math.PI * 2])
